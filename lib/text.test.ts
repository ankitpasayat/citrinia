// Spec: a peel's body is plain text with two live bits in it -- @handles, which
// notify somebody and link to a profile, and #hashtags, which link to a search.
// tokenize() splits the text into those runs so the renderer never has to parse
// anything itself, and extractMentions() answers "who does this peel notify".
//
